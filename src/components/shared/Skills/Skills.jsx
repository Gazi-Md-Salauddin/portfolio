...
const frontend = ["Next.js","React","Typescript","Javascript","Tailwind","CSS","HTML","Better Auth"]
const backend = ["ExpressJs", "NodeJs", "MongoDB", "JWT"]
const tools = ["Vs code", "Git", "GitHub", "Figma", "Vercel", "Netlify"]
  ...
  return (
    <motion.section id="skills" initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    viewport={{ once: true, amount: 0.3 }} className="py-18 bg-[#0F172A]">
